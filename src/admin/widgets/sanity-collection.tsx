...
import { AdminCollection, DetailWidgetProps } from "@medusajs/types"
...
const CollectionWidget = ({ data }: DetailWidgetProps<AdminCollection>) => {
  const { mutateAsync, isPending } = useTriggerSanityEntitySync(data.id, "collection")
